...
var findName = function(province, cityid, district) {
  var result = {
    province: null,
    cityid: "",
    district: "",
  ...
  for (var key in city.shop_province_list) {
    var shop_province = city.shop_province_list[key];
    if (shop_province["region_id"] == province) {
      result.province = shop_province.region_name;
      result.province_id = shop_province["region_id"];
      break;
    }
  }

  if (result.province_id != null) {
    for (var key in city.city_list[result.province_id]) {
      var shop_province = city.city_list[result.province_id][key];
      if (shop_province["region_id"] == cityid) {
        result.cityid = shop_province.region_name;
        result.cityid_id = shop_province["region_id"];
        break;
      }
    }
  }
  if (result.cityid_id != null) {
    for (var key in city.district_list[result.cityid_id]) {
      var shop_province = city.district_list[result.cityid_id][key];
      if (shop_province["region_id"] == district) {
        result.district = shop_province.region_name;
        result.district_id =  shop_province["region_id"];
        break;
      }
    }
  }
  if (result.province == null) {
    ...
    result.address = result.province + " " + result.cityid + " " + result.district
  }
  return result;
}
var findID = function (province,city_name,district){
  var result = {
    province: null,
    city: null,
    district: null,
  ...
  for (var key in city.shop_province_list) {
    var shop_province = city.shop_province_list[key];
    if (shop_province["region_name"] == province) {
      result.province = shop_province.region_id;
      break;
    }
  }
  if (result.province != null) {
    for (var key in city.city_list[result.province]) {
      var shop_province = city.city_list[result.province][key];
      if (shop_province["region_name"] == city_name) {
        result.city = shop_province.region_id;
        break;
      }
    }
  }
  if (result.city != null) {
    for (var key in city.district_list[result.city]) {
      var shop_province = city.district_list[result.city][key];
      if (shop_province["region_name"] == district) {
        result.district = shop_province.region_id;
        break;
      }
    }
  }
